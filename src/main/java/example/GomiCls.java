...
public class GomiCls implements java.io.Serializable {
	...
	private long rcnt;
	private ArrayList<GomiCls> rsltvec_;
...
/*--------------------------------------------------------------------------*/
	public void execSetResult(ResultSet rs_ ) throws SQLException {
		rsltvec_ = new ArrayList<GomiCls>();
		try{
			while( rs_.next() ){
...
/*  更新内容：                                                              */
/*--------------------------------------------------------------------------*/
	public final ArrayList<GomiCls> getResult(){
		return rsltvec_;
	}
...
/*  更新内容：                                                              */
/*--------------------------------------------------------------------------*/
	public final ArrayList<GomiCls> getResult( int stcnt_ , int endcnt_ ){
		ArrayList<GomiCls> rtn_ = new ArrayList<GomiCls>();
		int i_;
